...
cursor.execute("SELECT C.country FROM population as C, olympic_game_participants as OGP, athlete as A WHERE A.country = C.country AND OGP.athlete_id = A.athlete_id GROUP BY C.country ORDER BY SUM(A.athlete_id) DESC")
